...
namespace Precision{
    ...
    template <typename Number_Type>
    Number_Type factorial_gamma(const Number_Type&, size_t = k_default_prec);

    template <typename Integer_Type>
    Integer_Type factorial(const Integer_Type&);

    template <typename Floating_Type>
    Floating_Type nlog(Floating_Type);
    ...
    template <typename Floating_Type>
    Floating_Type exp(const Floating_Type&, size_t = k_default_prec);
